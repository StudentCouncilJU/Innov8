...
const Card = ({ name, description, link, image }: CardProps) => {
  ...
  return (
    <>
      ...
      >
        <Image src={image || "/posters/2.jpg"} alt={name} width={300} height={300} className="rounded-lg" />
        <h1 className='text-white font-anton text-2xl uppercase'>{name}</h1>
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                className="mb-6"
              >
                <h2 className="text-white font-anton text-3xl uppercase mb-4">{name}</h2>
              ...
              >
                <div>
                  <h3 className="text-blue-400 font-anton text-xl mb-2">Description</h3>
                  <p className="text-white/80 leading-relaxed">
                    {description || "Join us for an exciting event that will challenge your skills and expand your horizons. This is a great opportunity to learn, network, and showcase your talents in a competitive environment."}
                  </p>
                </div>
